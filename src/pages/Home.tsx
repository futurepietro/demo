    ...
    private renderUsers(): JSX.Element {
        ...
        return (
            <Paper className={classNames(classes.paper, classes.users)}>
                <h3 className={classes.sectionTitle}>Contatos</h3>
    ...
    private renderRadialBarChart(): JSX.Element {
        return (
            <Paper className={this.props.classes.paper}>
                <h3 className={this.props.classes.sectionTitle}>Historico de personagems</h3>
                ...
                <Grid container={true} spacing={24}>
                    <Grid item={true} lg={3} xs={12} sm={6}>
                        <Paper className={classNames(classes.paper, classes.headerTiles)}>
                            ...
                            <Typography className={classes.tileText}> {this.props.users.items.length} Contatos</Typography>
                        </Paper>
                    </Grid>
                    <Grid item={true} lg={3} xs={12} sm={6}>
                        <Paper className={classNames(classes.paper, classes.headerTiles)}>
                    ...
                    <Grid item={true} lg={3} xs={12} sm={6}>
                        <Paper className={classNames(classes.paper, classes.headerTiles)}>
                            ...
                            <Typography className={classes.tileText}>Compras</Typography>
                        </Paper>
                    </Grid>
                    <Grid item={true} lg={3} xs={12} sm={6}>
                        <Paper className={classNames(classes.paper, classes.headerTiles)}>
                            <SettingsIcon className={classes.headerTileIcon} />
                            <Typography className={classes.tileText}>Ferramentas</Typography>
                        </Paper>
                    </Grid>
